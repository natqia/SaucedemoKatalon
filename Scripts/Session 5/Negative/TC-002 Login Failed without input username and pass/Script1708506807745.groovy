...
warningUsernameRequired = WebUI.getText(findTestObject('Object Repository/Page_Swag Labs/h3_Epic sadface Username is required'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyMatch(warningUsernameRequired, 'Epic sadface: Username is required', false)
