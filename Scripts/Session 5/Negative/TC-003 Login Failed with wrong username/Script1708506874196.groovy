...
def username = dataLogin.getObjectValue('Username', 7)
WebUI.comment(username)
def password = dataLogin.getObjectValue('Password', 7)
...
warningUnregisteredAccount = WebUI.getText(findTestObject('Object Repository/Page_Swag Labs/h3_Epic sadface Username and password do not match any user in this service'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyMatch(warningUnregisteredAccount, 'Epic sadface: Username and password do not match any user in this service', false)
