...
expectedDetailItem = WebUI.getText(findTestObject('Object Repository/Page_Swag Labs/button_Back to products'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyMatch(expectedDetailItem, 'Back to products', false)
